...
const BlockTotalProfit = (props: BlockTotalProfitProps) => {
  ...
  return (
    <div
      className={`flex flex-col gap-1 rounded-[40px] p-6 border border-white shadow-sm bg-linear-to-tr ${profit && profit < 0 ? "from-red-6 to-red-5" : "from-green-18 to-green-17"}`}
    >

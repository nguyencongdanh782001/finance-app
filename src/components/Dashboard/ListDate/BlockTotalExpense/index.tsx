...
const BlockTotalExpense = (props: BlockTotalExpenseProps) => {
  ...
  return (
    <div className="flex flex-col gap-1 rounded-[40px] p-6 border border-white shadow-md bg-linear-to-tr from-orange-2 to-orange-5">
      <p className="text-green-1 text-13px font-bold uppercase">
        Tổng chi tiêu tháng {defaultMonth}
      </p>
      {isLoading ? (
